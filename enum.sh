...
git config --global user.name "enamulhaque"
...
git commit -m "Added infinity library"
...
git remote set-url origin https://github.com/enamulhaque028/infinity_library.git
############
# Step: 07 #
############
...
git push --all -f https://github.com/enamulhaque028/infinity_library.git
